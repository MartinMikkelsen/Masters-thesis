\documentclass[twoside,a4paper,oldfontcommands]{memoir}
% MEMOIR LAYOUT
...
\setlrmargins{30mm}{*}{10mm}
\setulmargins{30mm}{*}{4cm}
...
\makeevenhead{standard}{\leftmark}{}{\thepage}
\makeoddhead{standard}{\thepage}{}{\rightmark}
...
\aliaspagestyle{chapter}{mychapter}    %Change plain to standard if you want the header on pages with chapter headings 

%\setlength{\cftbeforechapterskip}{0.6em}% Change to suit your needs...
