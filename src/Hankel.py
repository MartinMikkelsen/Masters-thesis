...
#plt.plot(photonenergies,N,label=r'$S=86.2$ MeV, $b=3.8$ fm, non-rel' ,color='r')
plt.plot(photonenergies,N_rel, label=r'$S=86.2$ MeV, $b=3.8$ fm, rel', color='r')
#plt.plot(photonenergies,M,label=r'$S=45.5$ MeV, $b=3.9$ fm, non-rel',color='g')
plt.plot(photonenergies,M_rel, label=r'$S=45.5$ MeV, $b=3.9$ fm, rel', color='g')
#plt.plot(photonenergies,P, label=r'$S=35.4$ MeV, $b=4.0$ fm, non-rel',color='navy')
