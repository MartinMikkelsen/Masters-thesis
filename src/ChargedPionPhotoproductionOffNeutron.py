...
if __name__ == '__main__':
    ...
    photonenergies1 = np.linspace(148.4,176,25)
    #plt.plot(photonenergies1,totalcross(photonenergies1,8.45995544,3.87503802),color='r',label=r"$S=$%0.2f, $b=$%0.2f" %(8.45995544,3.87503802))
